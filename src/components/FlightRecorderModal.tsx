...
export default function FlightRecorderModal() {
  ...
  return (
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) setIsModalOpen(false) }}>
      <div className="modal-box" style={{ maxWidth: '600px', width: '100%', maxHeight: '85vh', height: activeTab === 'comments' ? '100%' : 'auto', marginBottom: '10vh', display: 'flex', flexDirection: 'column' }}>
